...
export default function IntroPage() {
  ...
  return (
    <main className="min-h-screen overflow-hidden md:overflow-hidden bg-white text-neutral-900 dark:bg-black dark:text-white">
      {/* ================================================================
          PAGE CONTENT
          Hidden until the globe is actually ready.
          ================================================================ */}
      <div
        className={`
      ...
      >
        <section className="relative min-h-screen lg:h-screen overflow-visible">
          ...
          {/* ============================================================
              GLOBE
              IMPORTANT: POSITIONING IS EXACTLY THE SAME AS ORIGINAL
              ============================================================ */}
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center h-full w-full">
              ...
              >
                ...
                >
                  ...
                  data and let AI analyze
                  trends, generate insights,
                      ...
                      >
                        ...
                        <p
                          className={`text-xs sm:text-sm text-neutral-500 -mt-1 ${
                            index === 1 ||
                            index === 2
                              ? "text-white sm:text-neutral-500"
                              : ""
                          }`}
                        >
                          {
